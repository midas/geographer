...
module Geographer
  module Countries
    ...
    COUNTRIES_LIST = [
      ...
      {:iso => 'GB', :name => 'UNITED KINGDOM', :printable_name => 'United Kingdom', :iso3 => 'GBR', :numcode => '826', :aka => ["Channel Islands", "England", "Northern Ireland", "Scotland", "UK", "Wales"] },
      ...
      {:iso => 'MK', :name => 'MACEDONIA, THE FORMER YUGOSLAV REPUBLIC OF', :printable_name => 'Macedonia, the Former Yugoslav Republic of', :iso3 => 'MKD', :numcode => '807', :aka => ["Macedonia", "Macedonia (Fyrom)"] },
      ...
      {:iso => 'MO', :name => 'MACAO', :printable_name => 'Macao', :iso3 => 'MAC', :numcode => '446', :aka => ["Macau (San), China"] },
      ...
      {:iso => 'RU', :name => 'RUSSIAN FEDERATION', :printable_name => 'Russian Federation', :iso3 => 'RUS', :numcode => '643', :aka => ["Russia"] },
      ...
      {:iso => 'TW', :name => 'TAIWAN, PROVINCE OF CHINA', :printable_name => 'Taiwan, Province of China', :iso3 => 'TWN', :numcode => '158', :aka => ["Taiwan"] },
      ...
      {:iso => 'US', :name => 'UNITED STATES', :printable_name => 'United States', :iso3 => 'USA', :numcode => '840', :aka => ["United States of America"] },
      ...
      {:iso => 'VG', :name => 'VIRGIN ISLANDS, BRITISH', :printable_name => 'Virgin Islands, British', :iso3 => 'VGB', :numcode => '092', :aka => ["British Virgin Islands"] },
      {:iso => 'VI', :name => 'VIRGIN ISLANDS, U.S.', :printable_name => 'Virgin Islands, U.s.', :iso3 => 'VIR', :numcode => '850', :aka => ["U.S. Virgin Islands"] },
      {:iso => 'VN', :name => 'VIET NAM', :printable_name => 'Viet Nam', :iso3 => 'VNM', :numcode => '704', :aka => ["Vietnam"] },
